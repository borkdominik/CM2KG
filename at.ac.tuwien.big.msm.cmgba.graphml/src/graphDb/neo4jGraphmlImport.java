...
public class neo4jGraphmlImport {
	...
	private String importGraphmlFile = "CALL apoc.import.graphml(\"http://cm2kgwebapp:8080/cm2kg/repository/graph/b2715d3a-9158-439b-8a2b-873089dd38d9\", {})";
	...
	public neo4jGraphmlImport(String graphUid) {
		importGraphmlFile = "CALL apoc.import.graphml(\"http://cm2kgwebapp:8080/cm2kg/repository/graph/" + graphUid
				+ "\", {storeNodeIds: true})";
	}
