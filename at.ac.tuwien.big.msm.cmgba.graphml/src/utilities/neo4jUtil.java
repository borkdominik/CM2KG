...
public class neo4jUtil implements AutoCloseable {
	...
	private String uri = "bolt://neo4j-cm2kg-instance:7687";
	...
	private String ea_CHATTY_SERVICE_QUERY_IMPROVED;
	private String ea_CYCLIC_DEPENDENCY_QUERY_IMPROVED;
	private String ea_DATA_SERVICE_QUERY_IMPROVED;
	private String ea_MESSAGE_CHAIN_QUERY_IMPROVED;
	...
	private void loadSmellQueries() {
		try {
			...
			ea_CHATTY_SERVICE_QUERY_IMPROVED = Files.readString(Path.of("smellQueries/ea_ChattyService_improved.neo4j"));
			ea_CYCLIC_DEPENDENCY_QUERY = Files.readString(Path.of("smellQueries/ea_CyclicDependency.neo4j"));
			ea_CYCLIC_DEPENDENCY_QUERY_IMPROVED = Files.readString(Path.of("smellQueries/ea_CyclicDependency_improved.neo4j"));
			ea_DATA_SERVICE_QUERY = Files.readString(Path.of("smellQueries/ea_DataService.neo4j"));
			ea_DATA_SERVICE_QUERY_IMPROVED = Files.readString(Path.of("smellQueries/ea_DataService_improved.neo4j"));
			...
			ea_MESSAGE_CHAIN_QUERY_IMPROVED = Files.readString(Path.of("smellQueries/ea_MessageChain_improved.neo4j"));
	...
	public String getEa_CHATTY_SERVICE_QUERY_IMPROVED() {
		return ea_CHATTY_SERVICE_QUERY_IMPROVED;
	}

	public String getEa_CYCLIC_DEPENDENCY_QUERY_IMPROVED() {
		return ea_CYCLIC_DEPENDENCY_QUERY_IMPROVED;
	}

	public String getEa_MESSAGE_CHAIN_QUERY_IMPROVED() {
		return ea_MESSAGE_CHAIN_QUERY_IMPROVED;
	}

	public String getEa_DATA_SERVICE_QUERY_IMPROVED() {
		return ea_DATA_SERVICE_QUERY_IMPROVED;
	}
}
